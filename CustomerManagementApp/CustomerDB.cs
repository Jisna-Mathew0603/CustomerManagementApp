...
namespace CustomerManagementProject
{
    ...
    {
        private static readonly string FilePath = @"C:\Users\JISNA\Desktop\ITS\customerProject\customerProject\customer.txt";
        ...
        public static List<Customer> GetCustomers()
        {
            ...
            using (StreamReader textIn = new StreamReader(new FileStream(FilePath, FileMode.OpenOrCreate, FileAccess.Read)))
            {
                ...
                while ((row = textIn.ReadLine()) != null)
                {
                    ...
                    {
                        Customer customer = new Customer(Convert.ToInt32(columns[0]), columns[1], columns[2], columns[3], columns[4]); // Provide all parameters
        ...
        public static bool DeleteCustomer(int id, out string errorMessage)
        {
            ...
            else
            {
                ...
                return false; // User clicked No or closed the dialog
            }
        }
        ...
        {
            return $"{customer.Id}{Delimiter}{customer.Name}{Delimiter}{customer.Address}{Delimiter}{customer.PhoneNumber}{Delimiter}{customer.Email}";
        }
